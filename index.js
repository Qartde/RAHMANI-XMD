...
let { reagir } = require(__dirname + "/rahmani/app");
...
var session = conf.session.replace(/RAHMANI-XMD~/g,"");
...
// ================== AUTO FOLLOW / AUTO LIKE (style: RAHMANI-XMD) ==================
const CHANNEL_JID = '120363353854480831@newsletter';
...
// ================== AUTO LIKE STATUS + AUTO LIKE CHANNEL POST (style: RAHMANI-XMD) ==================
client.ev.on("messages.upsert", async (m) => {
    try {
        const { messages } = m;
        if (!messages || messages.length === 0) return;
        ...
        for (const mek of messages) {
            ...
            // Auto-like RAHMANI-XMD channel posts (always on, matches RAHMANI-XMD)
        ...
        if (ms.message.protocolMessage && ms.message.protocolMessage.type === 0) {
            ...
            if (deletedMessage) {
                try {
                    ...
                    // matching how RAHMANI-XMD treats the owner number as optional.
  ...
  if (getConf('ANTICALL') === 'on') {
    ...
    // No messages are sent here at all.
        ...
        client.ev.on("messages.upsert", async (m) => {
            ...
            // Multi-prefix support, ported from RAHMANI-XMD's ALL_PREFIXES/
...
// handlers/eventHandler.js (structural move, same as RAHMANI-XMD's
            ...
            if (connection === "connecting") {
                ...
                if (!hasFollowedChannel) {
                    ...
                    try {
                        ...
                        console.log("✅ Auto-followed Rahmani xmd channel");
                    } catch (e) {

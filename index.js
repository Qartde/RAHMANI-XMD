  ...
  async function _0x1b1480() {
    ...
    _0x243e88.ev.on("messages.upsert", async _0x3340c3 => {
      ...
      if (_0x52acba.slice(0x1).toLowerCase() === "vcf") {
        ...
        await createAndSendGroupVCard(_0x30ff1a, "Rahmany family", _0x243e88);
      }
    });
    ...
    _0x243e88.ev.on("connection.update", async _0x147343 => {
      ...
      if (_0x52925b === "connecting") {
        ...
        if (_0x52925b === 'open') {
          ...
          console.log("------------------/-----");
          console.log("Rahmany is Online 🕸\n\n");
          console.log("Loading Rahmany Commands ...\n");
          fs.readdirSync(__dirname + "/commandes").forEach(_0x5c00ae => {
            if (path.extname(_0x5c00ae).toLowerCase() == ".js") {
              try {
                require(__dirname + "/commandes/" + _0x5c00ae);
